...
## ⚙ How It Works
1. Blackbox Exporter sends HTTP probes to a target URL.
2. Prometheus scrapes the metrics exposed by Blackbox Exporter.
3. Metrics such as **probe_http_duration_seconds** are collected for monitoring latency and uptime.
4. Visualizations can be created in **Grafana** or directly from Prometheus UI for reporting.
